...
export class SelfStakingPoolFactory extends ethereum.SmartContract {
  static bind(address: Address): SelfStakingPoolFactory {
    return new SelfStakingPoolFactory("SelfStakingPoolFactory", address);
  }
